...
export default class SideMgr {
     ...
     * 当前界面使用的卖量列表
     */
    private static $boxes: IYDHW.GameBase.ISideBoxResult[];
    /**
     * 当前配置可使用的卖量列表
     */
    private static $boxesZ: IYDHW.GameBase.ISideBoxResult[];
    /**
     * 积分墙数据列表
     */
     ...
     * 获取卖量数据，适用于非首屏界面
     */
    public static getSides(): IYDHW.GameBase.ISideBoxResult[] {
     ...
     * @param data 
     */
    public static removeSide(data: IYDHW.GameBase.ISideBoxResult): void {
     ...
     */
    public static setSvrSide(datas: IYDHW.GameBase.ISideBoxResult[]): void {
        var self = SideMgr;
        var config = self.$svrConfig = {
            timestamp: 0,
            version: '1.0.0',
