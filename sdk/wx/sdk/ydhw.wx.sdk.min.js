...
var Url = /** @class */ (function () {
    ...
    Url.SetAllIsDebugMode = function (isDebug) {
        for (var i = 0; i < Url.AllUrls.length; i++) {
            var url = Url.AllUrls[i];
            url._IsDebug = isDebug;
        }
    };
...
var SDKPlatform = /** @class */ (function () {
    ...
    SDKPlatform.prototype.CreateRewardVideoAd2 = function (adUnitId, caller, onClose, onError) {
        throw new Error("Method not implemented.");
    };
    SDKPlatform.prototype.ShowRewardVideoAd2 = function (caller, onLoad, onShow, onException) {
        throw new Error("Method not implemented.");
    };
...
var WechatCommerce = /** @class */ (function (_super) {
    ...
    WechatCommerce.prototype.Login = function (caller, method) {
        ...
        this.Platform.Login(this, function (code, token, result) {
            ...
            _this.Error("登录失败Error:" + JSON.stringify(error));
    ...
    WechatCommerce.prototype.ShareAppMessage = function (scene, channel, module, inviteType, caller, method, target) {
        ...
        if (shareList && shareList.length > 0) {
            ...
            this.Platform.ShareAppMessage(card_1.title, card_1.img, queryData, this, function () {
                ...
                //分享图统计（打点统计）
                var shareInfo = new _Model_Statistic__WEBPACK_IMPORTED_MODULE_6__["StatistiicShareInfo"](nowTime, card_1.id, 0);
    ...
    WechatCommerce.prototype.ShowGridAd = function () {
        ...
        this.Platform.ShowGridAd(this, function () {
            ...
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_1__["SDK"].Commerce.StatisticGrid(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_3__["EM_STATISTIC_TYPE"].SHOW, _this.Platform.GridAdId);
        }, function () {
        });
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_1__["SDK"].Statistic_Api.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_3__["COMMERCE_API"].GetSetting, _framework_Define__WEBPACK_IMPORTED_MODULE_5__["EM_PLATFORM_TYPE"].Wechat, null);
    };
...
var HeartBeatSystem = /** @class */ (function () {
    ...
    HeartBeatSystem.prototype.StartUploadTime = function () {
        ...
        _framework_Utility_TimerUtility__WEBPACK_IMPORTED_MODULE_0__["default"].AddTimer(this._UploadTimeTimerId, this._timeSpace, this, null, function () {
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_1__["SDK"].Commerce.StatisticDuration();
            if (_this._timeChange) {
                _this._timeChange = false;
                _this.StartUploadTime();
            }
            return false;
        });
    };
     ...
     */
    HeartBeatSystem.prototype.SetTimeSpace = function (times) {
        if (times && times >= 1) {
            this._timeSpace = times * 1000;
            this._timeChange = true;
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_1__["SDK"].Commerce.Log("SetTimeSpace-times:", times);
        }
    };
    /**
     * 同步在线时长定时器-停止
...
/*!*******************************************!*\
  !*** ./sdk/Extensions/StatisticSystem.ts ***!
  \*******************************************/
/*! exports provided: StatisticSystem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticSystem", function() { return StatisticSystem; });
/* harmony import */ var _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../SDK/Declare */ "./sdk/SDK/Declare.ts");
/* harmony import */ var _SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../SDK/EventDef */ "./sdk/SDK/EventDef.ts");
/* harmony import */ var _framework_Define__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../framework/Define */ "./framework/Define.ts");
/* harmony import */ var _Model_Default__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Model/Default */ "./sdk/Model/Default.ts");
/* harmony import */ var _framework_Utility_TimerUtility__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../framework/Utility/TimerUtility */ "./framework/Utility/TimerUtility.ts");





var StatisticSystem = /** @class */ (function () {
    function StatisticSystem() {
        this._StatisticTimerId = "_StatisticTimerId";
        this.listInfoBanner = [];
        this.listInfoVideo = [];
        this.listInfoInterstitial = [];
        this.listInfoGrid = [];
        this.listInfoAppBox = [];
        this.listInfoBlock = [];
        this.listInfoNativeAd = [];
        this.listResult = [];
        this.listEvent = [];
        this.listClickOut = [];
        this._timerStart = false;
        //当前请求的参数缓存
        this.requestBannerInfo = null;
        this.requestVideoInfo = null;
        this.requestInterstitialInfo = null;
        this.requestGridInfo = null;
        this.requestAppBoxInfo = null;
        this.requestBlockInfo = null;
        this.requestNativeInfo = null;
        this.requestResultInfo = null;
        this.requestEventInfo = null;
        this.requestClickOutInfo = null;
    }
    StatisticSystem.prototype.Initialize = function () {
    };
    StatisticSystem.getInstance = function () {
        return StatisticSystem.instance;
    };
    /**
     *
     ...
     * @param adId 广告id
     */
    StatisticSystem.prototype.StatisticBanner = function (type, adId) {
        if (!this.checkStatisticAdInfo("StatisticBanner", type, adId))
            return;
        this.listInfoBanner.push({ type: type, adId: adId });
        this.pushStatisticData();
    };
    StatisticSystem.prototype.RequestBanner = function (type, adId) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].Banner, type, adId, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticBanner success type:" + type);
                _this.listInfoBanner.shift();
            }
            _this.requestBannerInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticVideo = function (type, adId) {
        if (!this.checkStatisticAdInfo("StatisticVideo", type, adId))
            return;
        this.listInfoVideo.push({ type: type, adId: adId });
        this.pushStatisticData();
    };
    StatisticSystem.prototype.RequestVideo = function (type, adId) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].Video, type, adId, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticVideo success type:" + type);
                _this.listInfoVideo.shift();
            }
            _this.requestVideoInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticInterstitial = function (type, adId) {
        if (!this.checkStatisticAdInfo("StatisticInterstitial", type, adId))
            return;
        this.listInfoInterstitial.push({ type: type, adId: adId });
        this.pushStatisticData();
    };
    StatisticSystem.prototype.RequestInterstitial = function (type, adId) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].InterstitialAd, type, adId, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticInterstitial success type:" + type);
                _this.listInfoInterstitial.shift();
            }
            _this.requestInterstitialInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticGrid = function (type, adId) {
        if (!this.checkStatisticAdInfo("StatisticGrid", type, adId))
            return;
        this.listInfoGrid.push({ type: type, adId: adId });
        this.pushStatisticData();
    };
    StatisticSystem.prototype.RequestGrid = function (type, adId) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].GridAd, type, adId, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticGrid success type:" + type);
                _this.listInfoGrid.shift();
            }
            _this.requestGridInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticAppBox = function (type, adId) {
        if (!this.checkStatisticAdInfo("StatisticAppBox", type, adId))
            return;
        this.listInfoAppBox.push({ type: type, adId: adId });
        this.pushStatisticData();
    };
    StatisticSystem.prototype.RequestAppBox = function (type, adId) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].AppBoxAd, type, adId, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticAppBox success type:" + type);
                _this.listInfoAppBox.shift();
            }
            _this.requestAppBoxInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticBlock = function (type, adId) {
        if (!this.checkStatisticAdInfo("StatisticBlock", type, adId))
            return;
        this.listInfoBlock.push({ type: type, adId: adId });
        this.pushStatisticData();
    };
    StatisticSystem.prototype.RequestcBlock = function (type, adId) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].BlockAd, type, adId, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticBlock success type:" + type);
                _this.listInfoBlock.shift();
            }
            _this.requestBlockInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticNativeAd = function (type, adId) {
        if (!this.checkStatisticAdInfo("StatisticNativeAd", type, adId))
            return;
        this.listInfoNativeAd.push({ type: type, adId: adId });
        this.pushStatisticData();
    };
    StatisticSystem.prototype.RequestNativeAd = function (type, adId) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].NativeAd, type, adId, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticNativeAd success type:" + type);
                _this.listInfoNativeAd.shift();
            }
            _this.requestNativeInfo = null;
        });
    };
    /**
     *
     * @param details 对象或数组
     */
    StatisticSystem.prototype.StatisticResult = function (details) {
        this.listResult.push({ details: details });
        this.pushStatisticData();
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["COMMERCE_API"].StatisticResult, _framework_Define__WEBPACK_IMPORTED_MODULE_2__["EM_PLATFORM_TYPE"].Common, null);
    };
    StatisticSystem.prototype.RequestResult = function (details) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].Result, details, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticResult success");
                _this.listResult.shift();
            }
            _this.requestResultInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticEvent = function (event, scene) {
        var time = new Date().getTime();
        this.listEvent.push({ event: event, scene: scene, time: time });
        if (_SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.SwitchEvent === false && scene !== 'LayerOn') {
            //关卡('LayerOn')进入次数统计事件不受事件开关控制
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticEvent is stop by SwitchEvent");
            return;
        }
        this.pushStatisticData();
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["COMMERCE_API"].StatisticEvent, _framework_Define__WEBPACK_IMPORTED_MODULE_2__["EM_PLATFORM_TYPE"].Common, null);
    };
    StatisticSystem.prototype.RequestEvent = function (event, scene, time) {
        var _this = this;
        var request = new _Model_Default__WEBPACK_IMPORTED_MODULE_3__["StatisticEventRequest"]();
        request.event = event;
        request.scene = scene;
        request.time = time;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].Event, [request], this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticEvent success");
                _this.listEvent.shift();
            }
            _this.requestEventInfo = null;
        });
    };
    StatisticSystem.prototype.StatisticClickOut = function (request) {
        if (!request) {
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticClickOut request is null");
            return;
        }
        if (!request.iconId) {
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticClickOut request.iconId is null");
            return;
        }
        if (!request.action) {
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticClickOut request.action is null");
            return;
        }
        this.listClickOut.push({ request: request });
        this.pushStatisticData();
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["COMMERCE_API"].StatisticClickOut, _framework_Define__WEBPACK_IMPORTED_MODULE_2__["EM_PLATFORM_TYPE"].Common, null);
    };
    StatisticSystem.prototype.RequestClickOut = function (request) {
        var _this = this;
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Statistic.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_1__["SDK_NET_API"].ClickOut, request, this, function (isOk) {
            if (isOk === true) {
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Log("StatisticClickOut success");
                _this.listClickOut.shift();
            }
            _this.requestClickOutInfo = null;
        });
    };
    /**
     * 检测参数是否存在
     ...
     * @param adId
     */
    StatisticSystem.prototype.checkStatisticAdInfo = function (name, type, adId) {
        if (type == null) {
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Warn(name + " type is null");
            return false;
        }
        if (!adId || adId == "") {
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.Warn(name + " adId is null");
            return false;
        }
        return true;
    };
    StatisticSystem.prototype.pushStatisticData = function () {
        var _this = this;
        if (!this._timerStart && !this.noData()) {
            _framework_Utility_TimerUtility__WEBPACK_IMPORTED_MODULE_4__["default"].RemoveTimer(this._StatisticTimerId);
            var me = this;
            _framework_Utility_TimerUtility__WEBPACK_IMPORTED_MODULE_4__["default"].AddTimer(this._StatisticTimerId, 1000, this, null, function () {
                if (_SDK_Declare__WEBPACK_IMPORTED_MODULE_0__["SDK"].Commerce.OnLine) {
                    if (_this.listInfoBanner && _this.listInfoBanner.length > 0 && _this.requestBannerInfo == null) {
                        _this.requestBannerInfo = _this.listInfoBanner[0];
                        _this.RequestBanner(_this.requestBannerInfo.type, _this.requestBannerInfo.adId);
                    }
                    if (_this.listInfoVideo && _this.listInfoVideo.length > 0 && _this.requestVideoInfo == null) {
                        _this.requestVideoInfo = _this.listInfoVideo[0];
                        _this.RequestVideo(_this.requestVideoInfo.type, _this.requestVideoInfo.adId);
                    }
                    if (_this.listInfoInterstitial && _this.listInfoInterstitial.length > 0 && _this.requestInterstitialInfo == null) {
                        _this.requestInterstitialInfo = _this.listInfoInterstitial[0];
                        _this.RequestInterstitial(_this.requestInterstitialInfo.type, _this.requestInterstitialInfo.adId);
                    }
                    if (_this.listInfoGrid && _this.listInfoGrid.length > 0 && _this.requestGridInfo == null) {
                        _this.requestGridInfo = _this.listInfoGrid[0];
                        _this.RequestGrid(_this.requestGridInfo.type, _this.requestGridInfo.adId);
                    }
                    if (_this.listInfoAppBox && _this.listInfoAppBox.length > 0 && _this.requestAppBoxInfo == null) {
                        _this.requestAppBoxInfo = _this.listInfoAppBox[0];
                        _this.RequestAppBox(_this.requestAppBoxInfo.type, _this.requestAppBoxInfo.adId);
                    }
                    if (_this.listInfoBlock && _this.listInfoBlock.length > 0 && _this.requestBlockInfo == null) {
                        _this.requestBlockInfo = _this.listInfoBlock[0];
                        _this.RequestcBlock(_this.requestBlockInfo.type, _this.requestBlockInfo.adId);
                    }
                    if (_this.listInfoNativeAd && _this.listInfoNativeAd.length > 0 && _this.requestNativeInfo == null) {
                        _this.requestNativeInfo = _this.listInfoNativeAd[0];
                        _this.RequestNativeAd(_this.requestNativeInfo.type, _this.requestNativeInfo.adId);
                    }
                    if (_this.listResult && _this.listResult.length > 0 && _this.requestResultInfo == null) {
                        _this.requestResultInfo = _this.listResult[0];
                        _this.RequestResult(_this.requestResultInfo.details);
                    }
                    if (_this.listEvent && _this.listEvent.length > 0 && _this.requestEventInfo == null) {
                        _this.requestEventInfo = _this.listEvent[0];
                        _this.RequestEvent(_this.requestEventInfo.event, _this.requestEventInfo.scene, _this.requestEventInfo.time);
                    }
                    if (_this.listClickOut && _this.listClickOut.length > 0 && _this.requestClickOutInfo == null) {
                        _this.requestClickOutInfo = _this.listClickOut[0];
                        _this.RequestClickOut(_this.requestClickOutInfo.request);
                    }
                }
                return _this.noData();
            });
    ...
    StatisticSystem.prototype.noData = function () {
        if (this.listInfoBanner && this.listInfoBanner.length != 0)
            return false;
        if (this.listInfoVideo && this.listInfoVideo.length != 0)
            return false;
        if (this.listInfoInterstitial && this.listInfoInterstitial.length != 0)
            return false;
        if (this.listInfoGrid && this.listInfoGrid.length != 0)
            return false;
        if (this.listInfoAppBox && this.listInfoAppBox.length != 0)
            return false;
        if (this.listInfoBlock && this.listInfoBlock.length != 0)
            return false;
        if (this.listInfoNativeAd && this.listInfoNativeAd.length != 0)
            return false;
        if (this.listResult && this.listResult.length != 0)
            return false;
        if (this.listEvent && this.listEvent.length != 0)
            return false;
        if (this.listClickOut && this.listClickOut.length != 0)
            return false;
        this._timerStart = false;
        return true;
    };
    StatisticSystem.instance = new StatisticSystem();
...
var Strategy = /** @class */ (function () {
    ...
    Strategy.prototype.GetShareResult = function (shareAppInfo, caller, method) {
        ...
        if (sharingStrategy) {
            ...
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_1__["SDK"].Commerce.Log("当前策略:", JSON.stringify(strategy));
            if (strategy.time && timeId < strategy.time.length) {
                var time_item = strategy.time[timeId];
                var item_prob = strategy.prob[timeId];
                _SDK_Declare__WEBPACK_IMPORTED_MODULE_1__["SDK"].Commerce.Log("time:" + JSON.stringify(time_item) + " , prob:" + JSON.stringify(item_prob) + ",time_space:", time_space);
...
var ApiMgr = /** @class */ (function (_super) {
    ...
    ApiMgr.prototype.UploadStatisticSdk = function () {
        var _this = this;
        if (!_SDK_Declare__WEBPACK_IMPORTED_MODULE_2__["SDK"].Commerce.OnLine) {
            return false;
        }
...
/* harmony import */ var _Extensions_HeartBeatSystem__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../Extensions/HeartBeatSystem */ "./sdk/Extensions/HeartBeatSystem.ts");
/* harmony import */ var _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../Extensions/StatisticSystem */ "./sdk/Extensions/StatisticSystem.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var CommerceMgr = /** @class */ (function (_super) {
    ...
    CommerceMgr.prototype._InnerLogin = function (caller, method) {
        ...
        _SDK_Declare__WEBPACK_IMPORTED_MODULE_2__["SDK"].Instance.InvokeMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_6__["SDK_NET_API"].Login, request, this, function (result) {
            ...
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_2__["SDK"].Platform.IsDebug = _this.SwitchLog;
            _this._Platform.IsDebug = _this.SwitchLog;
            _framework_Utility_Url__WEBPACK_IMPORTED_MODULE_5__["Url"].SetAllIsDebugMode(_this.SwitchLog);
            ...
            _this.GetCustomConfig(_this, function (result) { }); //获取自定义配置
            _this.StatisticDuration();
            _Extensions_HeartBeatSystem__WEBPACK_IMPORTED_MODULE_18__["HeartBeatSystem"].getInstance().StartUploadTime();
        }, function () {
    ...
    CommerceMgr.prototype.StatisticBanner = function (type, adId) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticBanner(type, adId);
        // if(!adId || adId=="") { return;}      
        // SDK.Statistic.InvokeMethod(SDK_NET_API.Banner, type, adId, this, (isOk: boolean) => {
        //     if (isOk === true) {
        //         this.Log("StatisticBanner success type:" + type);
        //     }
        // });
    };
    CommerceMgr.prototype.StatisticVideo = function (type, adId) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticVideo(type, adId);
        // if(!adId || adId=="") { return;}
        // SDK.Statistic.InvokeMethod(SDK_NET_API.Video, type, adId, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticVideo success type:" + type);
        //     }
        // });
    };
    CommerceMgr.prototype.StatisticInterstitial = function (type, adId) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticInterstitial(type, adId);
        // if(!adId || adId=="") { return;}
        // SDK.Statistic.InvokeMethod(SDK_NET_API.InterstitialAd, type, adId, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticInterstitial success type:" + type);
        //     }
        // });
    };
    CommerceMgr.prototype.StatisticGrid = function (type, adId) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticGrid(type, adId);
        // SDK.Statistic.InvokeMethod(SDK_NET_API.GridAd, type, adId, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticGrid success type:" + type);
        //     }
        // });
    };
    CommerceMgr.prototype.StatisticAppBox = function (type, adId) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticAppBox(type, adId);
        // SDK.Statistic.InvokeMethod(SDK_NET_API.AppBoxAd, type, adId, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticAppBox success type:" + type);
        //     }
        // });
    };
    CommerceMgr.prototype.StatisticBlock = function (type, adId) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticBlock(type, adId);
        // SDK.Statistic.InvokeMethod(SDK_NET_API.BlockAd, type, adId, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticBlock success type:" + type);
        //     }
        // });
    };
    CommerceMgr.prototype.StatisticNativeAd = function (type, adId) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticNativeAd(type, adId);
        // SDK.Statistic.InvokeMethod(SDK_NET_API.NativeAd, type, adId, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticNativeAd success type:" + type);
        //     }
        // });
    };
    CommerceMgr.prototype.StatisticErrorStack = function (ErrStack, LogStr, strDate) {
        ...
        try {
            ...
            if (systemInfo) {
                ...
                clientLogRequest.SDKVersion = this.SDK_VERSION;
            ...
            this.Warn("StatisticErrorStack-err:", err);
        }
    };
    /**
     *
    ...
    CommerceMgr.prototype.StatisticResult = function (details) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticResult(details);
        // SDK.Statistic.InvokeMethod(SDK_NET_API.Result, details, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticResult success");
        //     }
        // });
        // this.InvokeMethod(COMMERCE_API.StatisticResult, EM_PLATFORM_TYPE.Common,null);
    };
    CommerceMgr.prototype.StatisticEvent = function (event, scene) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticEvent(event, scene);
        // this.InvokeMethod(COMMERCE_API.StatisticEvent, EM_PLATFORM_TYPE.Common);
        // if (this.SwitchEvent === false && scene !== 'LayerOn') {
        //     //关卡('LayerOn')进入次数统计事件不受事件开关控制
        //     this.SwitchLog && this.Log("StatisticEvent is stop by SwitchEvent");
        //     return;
        // }
        // let request = new StatisticEventRequest();
        // request.event = event;
        // request.scene = scene;
        // request.time = new Date().getTime();
        // SDK.Statistic.InvokeMethod(SDK_NET_API.Event, [request], this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticEvent success");
        //     }
        // });
        // this.InvokeMethod(COMMERCE_API.StatisticEvent, EM_PLATFORM_TYPE.Common,null);
    };
    ...
    CommerceMgr.prototype.StatisticClickOut = function (request) {
        _Extensions_StatisticSystem__WEBPACK_IMPORTED_MODULE_19__["StatisticSystem"].getInstance().StatisticClickOut(request);
        // if (!request) {
        ...
        //     return;
        // }
        // SDK.Statistic.InvokeMethod(SDK_NET_API.ClickOut, request, this, (isOk: boolean): void => {
        //     if (isOk === true) {
        //         this.Log("StatisticClickOut success");
        //     }
        // });
        // this.InvokeMethod(COMMERCE_API.StatisticClickOut, EM_PLATFORM_TYPE.Common,null);
    };
                ...
                _this.ListCustomConfig.forEach(function (element) {
                    ...
                    if (element.name == 'ydhw_duration' && element.type == "1" && element.value) {
                        ...
                        try {
                            ...
                            _this.Warn("GetCustomConfig-parse ydhw_duration-error", e);
                        }
                        _Extensions_HeartBeatSystem__WEBPACK_IMPORTED_MODULE_18__["HeartBeatSystem"].getInstance().SetTimeSpace(time);
                    }
                });
    ...
    CommerceMgr.prototype.ShowBannerAd = function () {
        ...
        if (this._Platform.BannerAd) {
            ...
            if (!create) {
                ...
                this.StatisticBanner(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_6__["EM_STATISTIC_TYPE"].SHOW, this._Platform.BannerAdId);
    ...
    CommerceMgr.prototype.ShowRewardVideoAd = function (unlockCustomNumber, isAddPower, caller, onClose) {
        ...
        this._Platform.ShowRewardVideoAd(this, function () {
            ...
            me.StatisticVideo(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_6__["EM_STATISTIC_TYPE"].SHOW, _this._Platform.RewardVideoAdId);
        ...
        //     this._RewardVideoDelayTimerId = TimerUtility.Delay(4 * 1000, this, () => {
        //         if (this._IsRewardVideoAdFinish === false && this._EvtOnCloseRewardVideoAd) {
        //             me.SwitchLog && me.Log("4秒内回调检测判断无广告返回，则触发回调传回播放失败");
        //             me._CallerRewardVideoAd && me._EvtOnCloseRewardVideoAd && me._EvtOnCloseRewardVideoAd.call(me._CallerRewardVideoAd, EM_VIDEO_PLAY_TYPE.VIDEO_PLAY_FAIL);
        //             me._EvtOnCloseRewardVideoAd = null;
        //         }
        //     });
        // }
    ...
    CommerceMgr.prototype.StatisticLayer = function (layerPath) {
        ...
        if (hasLayer && p_index != -1) {
            ...
            this.Warn("statisticLayer-layerPath not found", 'warn');
        }
    ...
    CommerceMgr.prototype.OnBackend = function (res) {
        if (this._Platform.IsShowBannerAd && !this._showInterstitialAd && !this._showVideoAd && !this._showShare) {
            console.log("YDHW has click Banner ? ", this._Platform.BannerAdId);
            this.StatisticBanner(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_6__["EM_STATISTIC_TYPE"].CLICK, this._Platform.BannerAdId);
        }
        _Extensions_HeartBeatSystem__WEBPACK_IMPORTED_MODULE_18__["HeartBeatSystem"].getInstance().StopUploadTimer();
        this._hasHide = true;
    ...
    StatisticMgr.prototype.Initialize = function () {
        ...
        this.DeclareMethod(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_4__["SDK_NET_API"].Duration, this, function (type, duration, caller, method) {
            _this._UrlDuration.AsGet()
                ...
                .End()
                .OnReceive(_this, function (response) {
                // SDK.Platform.IsDebug && Log.Log("Duration Response=", response);
                if (response.code === 0) {
                    caller && method && method.call(caller, true);
                }
                else {
...
/* harmony import */ var _Model_Default__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Model/Default */ "./sdk/Model/Default.ts");
/* harmony import */ var _Model_Statistic__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Model/Statistic */ "./sdk/Model/Statistic.ts");
/* harmony import */ var _SDK_EventDef__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../SDK/EventDef */ "./sdk/SDK/EventDef.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var WechatPlatform = /** @class */ (function (_super) {
    ...
    WechatPlatform.prototype.ShowRewardVideoAd = function (caller, onShow, onException) {
        ...
        this.RewardVideoAd.load().then(function () {
            _SDK_Declare__WEBPACK_IMPORTED_MODULE_2__["SDK"].Commerce.StatisticVideo(_SDK_EventDef__WEBPACK_IMPORTED_MODULE_5__["EM_STATISTIC_TYPE"].LOAD_SUCCESS, _this.RewardVideoAdId);
    ...
    WechatPlatform.prototype.CreateGridAd = function (isShow, adId, adTheme, gridCount, style, caller, onLoad, onError) {
        var _this = this;
    ...
    WechatPlatform.prototype.ShowGridAd = function (caller, onSuccess, onError) {
        var me = this;
        this.GridAd && this.GridAd.show().then(function () {
            caller && onSuccess && onSuccess.call(caller);
