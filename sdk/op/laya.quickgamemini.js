...
window.layalib(function(window,document,Laya){
	...
	var HTMLImage=laya.resource.HTMLImage,Handler=Laya.Handler,Input=laya.display.Input,Loader=laya.net.Loader;
	...
	*/
	__proto.load=function(url,type,cache,group,ignoreCache){
		...
		if (Loader.parserMap[type] !=null){
			...
			if (((Loader.parserMap[type])instanceof Laya.Handler ))Loader.parserMap[type].runWith(this);
